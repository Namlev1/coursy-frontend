...
export default function QuickActionsSection({ title, actions, theme }: QuickActionsSectionProps) {
  const getPlusIcon = () => (
    <svg className="mr-2 -ml-1" fill="currentColor" height="20" viewBox="0 0 256 256" width="20" xmlns="http://www.w3.org/2000/svg">
