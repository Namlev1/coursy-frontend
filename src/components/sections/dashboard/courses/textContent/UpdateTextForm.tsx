...
import { updateText } from '@/lib/apiClient/requests/textContent';
...
interface UpdateTextFormProps {
  textContent: TextContent;
}

export default function UpdateTextForm({ textContent }: UpdateTextFormProps) {
