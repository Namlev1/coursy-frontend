...
import { updateQuiz } from '@/lib/apiClient/requests/quiz';
...
export default function UpdateQuizForm({ quizDto }: UpdateQuizFormProps) {
  ...
  useEffect(() => {
    if (quizDto) {
      reset({
        title: quizDto.quizTitle,
        synopsis: quizDto.quizSynopsis || '',
